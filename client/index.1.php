...
<script src="./common/js/codemirror.js?ver=<?php  echo date("Y-m-d-H:i:s") ?>" async></script>
<script src="./common/js/javascript.js?ver=<?php  echo date("Y-m-d-H:i:s") ?>" async></script>
